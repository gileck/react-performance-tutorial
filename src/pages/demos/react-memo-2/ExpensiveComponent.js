...
// Shared component for both demos that accepts an object prop
const ExpensiveComponent = ({ config }) => {
  console.log(`Rendering ExpensiveComponent with label: ${config.label}`);
